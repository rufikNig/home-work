...
class AccountServiceTest {
    ...
    void getMaxAccountBalance() {
        Account accountWithMaxBalance = Account.builder().id(1L).id(4L).balance(new BigDecimal(150000)).build();
        Set<Account> accounts = new HashSet() {{
            add(Account.builder().id(1L).id(1L).balance(BigDecimal.TEN).build());
            add(Account.builder().id(1L).id(2L).balance(new BigDecimal(200)).build());
            add(Account.builder().id(1L).id(3L).balance(new BigDecimal("1.65")).build());
